  ...
  <footer class="bg-white dark:bg-gray-800 rounded">
    <div class="p-4 mx-auto lg:-10">
      <div class="grid pt-4 grid-cols-2 lg:grid-cols-5">
        ...
        <div
          ...
          <ul class="text-gray-500 dark:text-gray-400">
            <li
              v-for="(link, index) in footerItem.links"
              :key="index"
              class="mb-4 text-xs">
      ...
      <div class="pt-10 text-center px-4">
        <div
          class="grid lg:grid-cols-2 lg:justify-items-between justify-items-between">
          <NuxtLink
            :to="localepath('/')"
            ...
            <img
              ...
              width="100"
              height="100"
              src="../public/img/f-logo.svg" />
            <img
              class="md:m-0 mx-auto hidden dark:block"
              width="100"
              height="100"
              src="../public/img/f-logo-dark.svg" />
          </NuxtLink>
          <form action="#" class="flex w-full max-w-sm lg:ms-auto">
            <div class="relative w-full">
              ...
              <input
                type="email"
                id="email"
                class="block outline-none p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-l rtl:rounded-l-none rtl:rounded-r border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                placeholder="Your email"
                required />
            </div>
            <button
              type="submit"
              class="py-3 px-5 text-sm text-center text-white rounded-r rtl:rounded-l rtl:rounded-r-none border cursor-pointer bg-primary-600 border-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
              Subscribe
            </button>
          </form>
        </div>
        ...
        <div class="grid grid-cols-3 md:space-y-0 space-y-5 justify-between">
          <div class="md:col-span-1 col-span-full">
            <span
              ...
              >© 2017-2023
              <a href="https://trader4.net" class="hover:underline">Bulutly</a>.
          ...
          <div class="md:col-span-1 col-span-full">
            <div class="flex md:justify-end justify-center space-x-6">
              <a
                href="#"
